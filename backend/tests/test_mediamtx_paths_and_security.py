...
class TestMediaMtxPathsAndSecurity(unittest.TestCase):
    ...
    def test_ssl_enabled_configuration(self):
        ...
        self.assertEqual(cfg.get("rtspServerKey"), "/data/certs/live/privkey.pem")
        self.assertEqual(cfg.get("rtspServerCert"), "/data/certs/live/fullchain.pem")
        self.assertEqual(cfg.get("rtmpServerKey"), "/data/certs/live/privkey.pem")
        self.assertEqual(cfg.get("rtmpServerCert"), "/data/certs/live/fullchain.pem")
        self.assertEqual(cfg.get("hlsServerKey"), "/data/certs/live/privkey.pem")
        self.assertEqual(cfg.get("hlsServerCert"), "/data/certs/live/fullchain.pem")
        self.assertEqual(cfg.get("webrtcServerKey"), "/data/certs/live/privkey.pem")
        self.assertEqual(cfg.get("webrtcServerCert"), "/data/certs/live/fullchain.pem")
        self.assertEqual(cfg.get("apiServerKey"), "/data/certs/live/privkey.pem")
        self.assertEqual(cfg.get("apiServerCert"), "/data/certs/live/fullchain.pem")
