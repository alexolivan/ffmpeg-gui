        ...
        <div className="p-4 overflow-y-auto custom-scrollbar space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
              ...
              {/* NVENC */}
              <div className={`p-2.5 bg-white/5 rounded-lg border ${options.nvenc ? 'border-brand-orange/40' : 'border-white/5'} col-span-full`}>
                <div className="flex items-center justify-between mb-1">
              ...
              {/* DeckLink */}
              <div className={`p-2.5 bg-white/5 rounded-lg border ${options.decklink ? 'border-brand-orange/40' : 'border-white/5'} col-span-full`}>
                <div className="flex items-center justify-between mb-1.5">
              ...
              {/* NDI */}
              <div className={`p-2.5 bg-white/5 rounded-lg border ${options.ndi ? 'border-brand-orange/40' : 'border-white/5'} col-span-full`}>
                <div className="flex items-center justify-between mb-1.5">
              ...
              {/* Auto Clean Option */}
              <div className="p-2 bg-white/5 rounded-lg border border-white/5 col-span-full">
                <div className="flex items-center justify-between">
                  <div className="flex flex-col">
