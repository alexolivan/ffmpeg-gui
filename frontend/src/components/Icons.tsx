...
export const ToolsIcon: React.FC<IconProps> = ({ size = 18, className = '', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const KnobsIcon: React.FC<IconProps> = ({ size = 18, className = '', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const DestinationIcon: React.FC<IconProps> = ({ size = 18, className = '', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const ExportIcon: React.FC<IconProps> = ({ size = 18, className = '', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const PencilIcon: React.FC<IconProps> = ({ size = 16, className = '', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
